...
export const PRODUCTS: Product[] = [
  { id: 7, nombre: 'Jogger jaspeado', precio: 44900, stock: 21, color: 'var(--df-brand-subtle)', txt: 'var(--df-brand-dark)', reglas: ['Si piden 2 o más, ofrece la promo "3 joggers por $109.900" sin que la pidan.', 'Si preguntan por talla, envía la guía de medidas antes de confirmar.'], fotos: ['Frente', 'Espalda', 'Detalle tela'], variantes: [{ label: 'M · Verde', stock: 6, fotos: 2 }, { label: 'L · Verde', stock: 4, fotos: 2 }, { label: 'M · Negro', stock: 7, fotos: 3 }, { label: 'L · Negro', stock: 4, fotos: 3 }] },
  { id: 1, nombre: 'Camiseta oversize algodón', precio: 59900, stock: 24, color: 'var(--df-indigo-subtle)', txt: 'var(--df-indigo)', reglas: ['Si compran 2 o más, aplica la promo "2 por $99.900" sin que la pidan.'], variantes: [{ label: 'S · Blanco', stock: 8 }, { label: 'M · Blanco', stock: 6 }, { label: 'M · Negro', stock: 7 }, { label: 'L · Negro', stock: 3 }] },
  { id: 2, nombre: 'Jean mom fit tiro alto', precio: 129900, stock: 12, color: 'var(--df-info-subtle)', txt: 'var(--df-info)', reglas: ['Sugiere la guía de tallas antes de confirmar. No hay cambios por talla en promoción.'], variantes: [{ label: '6 · Azul claro', stock: 4 }, { label: '8 · Azul claro', stock: 5 }, { label: '10 · Azul oscuro', stock: 3 }] },
  { id: 3, nombre: 'Bolso tote cuero vegano', precio: 89900, stock: 8, color: 'var(--df-warning-subtle)', txt: 'var(--df-warning)', reglas: ['Combínalo con el collar dorado cuando pregunten por regalos.'], variantes: [{ label: 'Único · Camel', stock: 5 }, { label: 'Único · Negro', stock: 3 }] },
  { id: 4, nombre: 'Gorra bordada logo', precio: 39900, stock: 30, color: 'var(--df-green-subtle)', txt: 'var(--df-green-700)', reglas: ['Producto de entrada: ofrécela como complemento de cualquier compra.'], variantes: [{ label: 'Única · Negra', stock: 18 }, { label: 'Única · Beige', stock: 12 }] },
  ...
  { id: 6, nombre: 'Collar acero dorado', precio: 34900, stock: 0, color: 'var(--df-surface-2)', txt: 'var(--df-text-secondary)', reglas: ['Agotado: ofrece avisar cuando llegue y sugiere el bolso tote.'], variantes: [{ label: 'Único · Dorado', stock: 0 }] },
];
...
export const INTEGRATIONS: Integration[] = [
  ...
  // Canales
  { id: 'wa', nombre: 'WhatsApp Business', logoText: 'WA', logoBg: 'var(--df-green-subtle)', logoTxt: 'var(--df-green-700)', grupo: 'canales', desc: 'El canal donde tu asistente atiende y vende. Se configura en la sección WhatsApp.', estado: 'disponible' },
  // Envíos
