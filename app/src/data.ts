...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: 'woocommerce', nombre: 'WooCommerce (Effi / Dropi)', logoText: 'Wo', logoBg: '#EDE9FE', logoTxt: '#6D28D9', grupo: 'envios', especial: 'woo', desc: 'Conecta tu tienda WooCommerce y tus pedidos se envían allí automáticamente. Effi o Dropi (el que tengas instalado en WordPress) genera la guía y despacha; nosotros sincronizamos estado e inventario. Con "Enviar productos" subimos tu catálogo (y generamos los SKU solos).', estado: 'disponible', campos: [{ key: 'url', label: 'URL de tu tienda WooCommerce', placeholder: 'https://mitienda.com' }, { key: 'consumerKey', label: 'Consumer Key', placeholder: 'ck_…', secreto: true }, { key: 'consumerSecret', label: 'Consumer Secret', placeholder: 'cs_…', secreto: true }] },
  // Publicidad
