...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: 'woocommerce', nombre: 'Effi (vía WooCommerce)', logoText: 'Ef', logoBg: '#EDE9FE', logoTxt: '#6D28D9', grupo: 'envios', especial: 'woo', desc: 'Conecta tu tienda WooCommerce para que Effi despache tus pedidos: se crea el pedido en Woo, Effi genera la guía y sincronizamos estado e inventario.', estado: 'disponible', campos: [{ key: 'url', label: 'URL de tu tienda WooCommerce', placeholder: 'https://mitienda.com' }, { key: 'consumerKey', label: 'Consumer Key', placeholder: 'ck_…', secreto: true }, { key: 'consumerSecret', label: 'Consumer Secret', placeholder: 'cs_…', secreto: true }] },
  // Publicidad
