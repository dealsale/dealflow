...
export function MResumen({ df }: { df: DealFlowState }) {
  return (
    <section data-screen-label="Móvil Resumen">
      ...
      <div style={{ ...card, border: 'none', color: 'var(--df-hero-fg)', marginBottom: 12, background: 'var(--df-hero-grad)' }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
          <div style={{ flex: 1, background: 'var(--df-hero-chip)', borderRadius: 9, padding: '8px 10px' }}>
